...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int[] hiraganaBtnIds = new int[]{
    ...
    private static final int[] katakanaBtnIds = new int[]{
    ...
    private static final int[] audio = new int[]{
...
asdasd
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        katakanaChangeViewBtn.setOnClickListener(view -> {
        ...
        for (int i = 0; i < hiraganaBtnIds.length; i++) {
            int mediaIndex = i;
            int id = hiraganaBtnIds[i];
        ...
        for (int i = 0; i < katakanaBtnIds.length; i++) {
            int mediaIndex = i;
            int id = katakanaBtnIds[i];
